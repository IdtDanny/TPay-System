<?php
    ...
    $agent_pin = $agentResults->agent_pin;
                ...
                <br>
                    <div class="notification-holder"> 
                        <?php
                            ...
                            $fetchDateQuery = 'SELECT `date_sent` FROM `notification` WHERE recieverid = :reciever AND `target`= :agent GROUP BY `date_sent` ORDER BY date_sent DESC';
